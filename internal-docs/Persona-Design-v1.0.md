...
> **2026-08-04 注記**: 本セクションの詳細ペルソナ定義（グループ1・2）はv1.0作成時（2026-06-19、13シーン体制）の内容のまま。2026-07-29以降のT-34でid14〜18の実用プレミアム5シーンが追加され、実装は現在合計**18シーン**（詳細は下記グループ3、および`docs/tasks/T-34_premium-pro-scenes.md`・`lib/services/scene_service.dart:160-204`参照）。
