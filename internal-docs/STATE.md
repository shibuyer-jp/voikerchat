...
18. **Google Play価格の引き下げ(App Store側へ揃える)**(2026-08-07追記)
    ...
    - 内容: Google Playの税抜価格を日本 ¥1,818 / フィリピン ₱713 程度へ引き下げる
    - **[未確認]** App Store側の価格表示が税込か税抜かが未確定。確定してから実施すること(税込/税抜の前提を誤ると、意図せずさらに安く、または高くなる)
    - 担当: 人間(Play Console操作)。期限: 未確認事項の解消後、速やかに
