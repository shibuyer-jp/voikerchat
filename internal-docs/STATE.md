...
- **Androidクローズドテスト**: 14日タイマー進行中(起算 2026-07-30 19:31 JST、**2026-08-10時点で10日目**)。Play Console表示「12人のテスターが10日間連続でオプトインしています」[確認済 2026-08-10、Play Console実画面]。完走見込みは従来どおり**2026-08-14前後で変更なし**。配信中のビルドはBuild 18(2026-08-06 13:46 JST公開)、まもなくBuild 21へ更新(下記「業者依頼」項参照)。統計情報の詳細はSTATE.md未完了項目4参照(3指標中2指標が引き続き取得不能)。旧: **2026-08-07時点で8日目**。オプトイン不通問題(SNS内蔵ブラウザ起因)は特定・解消済み。詳細はDECISIONS.md 2026-07-30参照。**運用知見**: Play Consoleの「12人」表示は仕様上の固定表示で実数ではなく、実際は毎日16〜19アカウントが稼働(テスター管理業者〈ココナラ経由〉からの回答、2026-08-04)
- **業者依頼「テスト中にアップデートを2〜3回」の充足状況**(2026-08-10確認): Build 16(2026-08-03 10:27 JST配信)・Build 18(2026-08-06 13:46 JST配信)の2回配信済みで下限は既に充足済み。**3回目としてBuild 21を配信する**(タスクA、PR #84でversionCode 21へ更新済み。実AABビルド・Play Consoleアップロードは人間が実施)。「運用ルール」節の**新AAB配信では14日タイマーはリセットされない**という既存記載と整合しており、Build 21配信もこの例外規定に含まれる(下記「運用ルール」節参照)
...
- Build 16(2026-08-03配信)・Build 18(2026-08-06配信)・Build 21(2026-08-10以降配信予定)のリリースのみ例外。**新AAB配信では14日タイマーはリセットされない**ため、今後もビルド配信自体は可能
